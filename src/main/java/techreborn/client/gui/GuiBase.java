...
import techreborn.client.container.TRContainer;
...
public class GuiBase extends GuiContainer {
	...
	public TRContainer container;
	public TRBuilder builder = new TRBuilder();
	public int xSize = 176;
	public int ySize = 176;

	public GuiBase(EntityPlayer player, TileEntity tile, TRContainer container, String name) {
		super(container);
